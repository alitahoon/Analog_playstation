...
@AndroidEntryPoint
class PlaystationReservationService_d5 : Service() {
    ...
    companion object{
        private val NOTIFICATION_CHANNEL=105
        private val NOTIFICATION_NAME="PLASTATION_RESERVATION5"
        private var NOTIFICATION_ID=102
...
//        }
    ...
    fun showNotification(playstationReservationEntity: PlaystationReservationEntity): Notification {
        ...
        val notification = NotificationCompat.Builder(
            this@PlaystationReservationService_d5,
            (NOTIFICATION_CHANNEL).toString()
        )
            .setColorized(true)
