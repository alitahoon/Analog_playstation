...
@AndroidEntryPoint
class PlaystationReservationService_d4 : Service() {
    ...
    companion object{
        private val NOTIFICATION_CHANNEL=104
        private val NOTIFICATION_NAME="PLASTATION_RESERVATION4"
        private var NOTIFICATION_ID=103
...
//        }
    ...
    fun showNotification(playstationReservationEntity: PlaystationReservationEntity): Notification {
        ...
        val notification = NotificationCompat.Builder(
            this@PlaystationReservationService_d4,
            (NOTIFICATION_CHANNEL).toString()
        )
            .setColorized(true)
