...
@AndroidEntryPoint
class PlaystationReservationService_d3 : Service() {
    ...
    companion object{
        private val NOTIFICATION_CHANNEL=103
        private val NOTIFICATION_NAME="PLASTATION_RESERVATION3"
        private var NOTIFICATION_ID=104
...
//        }
    ...
    fun showNotification(playstationReservationEntity: PlaystationReservationEntity): Notification {
        ...
        val notification = NotificationCompat.Builder(
            this@PlaystationReservationService_d3,
            (NOTIFICATION_CHANNEL).toString()
        )
            .setColorized(true)
